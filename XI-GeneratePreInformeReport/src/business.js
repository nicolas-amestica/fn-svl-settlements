 ...
 */
module.exports.getData = async (context) => {
 ...
 * @return {Json}: Respuesta JSON que contiene respuesta del resultado de proceso, si falla retorna excepción.
 */
module.exports.exportToXlsx = async (context, data) => {

    try {

        context.log('GENERANDO INFORME');
 ...
 */
module.exports.deleteFile = async (context) => {
