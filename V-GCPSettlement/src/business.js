'use-strinct'
const managementReport = require('./management/geGCPReport');
...
module.exports.getReport = async () => {
    ...
    try {
        ...
        let data = await managementReport.getDataGcp();
        if (data.error !== undefined)
            return data;

        /** EXPORTAR DATA A ARCHIVO XLSX. */
        data = await managementReport.exportToXlsxFromObject(data, 'GCP_PorLiquidar');
